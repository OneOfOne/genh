...
func insertionSortOrdered[Elem Ordered](data []Elem, a, b int) {
	for i := a + 1; i < b; i++ {
...
func siftDownOrdered[Elem Ordered](data []Elem, lo, hi, first int) {
	root := lo
	for {
		child := 2*root + 1
		if child >= hi {
...
func heapSortOrdered[Elem Ordered](data []Elem, a, b int) {
	first := a
	lo := 0
	hi := b - a
...
func medianOfThreeOrdered[Elem Ordered](data []Elem, m1, m0, m2 int) {
	// sort 3 elements
	if data[m1] < data[m0] {
...
func swapRangeOrdered[Elem Ordered](data []Elem, a, b, n int) {
	for i := 0; i < n; i++ {
		data[a+i], data[b+i] = data[b+i], data[a+i]
	}
}

func doPivotOrdered[Elem Ordered](data []Elem, lo, hi int) (midlo, midhi int) {
...
func quickSortOrdered[Elem Ordered](data []Elem, a, b, maxDepth int) {
...
func stableOrdered[Elem Ordered](data []Elem, n int) {
...
func symMergeOrdered[Elem Ordered](data []Elem, a, m, b int) {
...
func rotateOrdered[Elem Ordered](data []Elem, a, m, b int) {
	i := m - a
	j := b - m
