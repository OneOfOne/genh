...
func siftDownOrdered[E Ordered](data []E, lo, hi, first int) {
	root := lo
	for {
		child := 2*root + 1
		if child >= hi {
...
func swapRangeOrdered[E Ordered](data []E, a, b, n int) {
	for i := 0; i < n; i++ {
		data[a+i], data[b+i] = data[b+i], data[a+i]
	}
}

func stableOrdered[E Ordered](data []E, n int) {
...
func symMergeOrdered[E Ordered](data []E, a, m, b int) {
...
func rotateOrdered[E Ordered](data []E, a, m, b int) {
	i := m - a
	j := b - m
